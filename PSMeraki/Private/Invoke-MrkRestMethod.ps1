function Invoke-MrkRestMethod {
    ...
    try {
        ...
        if ($_.exception.message -match [regex]::Escape('(429)')){
            ...
            Start-Sleep 1
             $request = Invoke-RestMethod -Method $Method -ContentType 'application/json; charset=utf-8' -Headers $mrkRestApiHeader -Uri $uri -Body ($body | ConvertTo-Json -Depth 10)
